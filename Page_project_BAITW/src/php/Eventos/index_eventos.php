      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="menu">
          <ul class="navbar-nav">
            ...
            <li class="nav-item"><a href="./index_eventos.php" class="me-auto nav-link active color-dark">Events</a></li>
            <li class="nav-item"><a href="../mantenimientos/index-mantenimientos.php" class="me-auto nav-link active color-dark">Maintenance</a></li>
            ...
            <li class="nav-item"><a href="../../php/index_bycle.php" class="me-auto nav-link active color-dark">Bikes</a></li>
          </ul>
        </div>
