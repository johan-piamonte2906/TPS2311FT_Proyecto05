...
<head>
    ...
    <!-- Api paypal -->
    <script src="https://www.paypal.com/sdk/js?client-id=AX3NvnpM6-UsLigj7gOBj8QqTJRhSsuzNH36EOjZXodSp7tyORrAQUDOLY9A9o4444wOjQXU7qqu8797&currency=COP"></script>
</head>
<body>
     <!-- Nav  -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a href="../index_bycle.html" class="me-auto nav-link active color-dark">Bikes</a></li>
                </ul>
            </div>
    ...
    <div class="container all-container">
        <div class="row">
            ...
            <div class="col" id="paypal-button-container">
                <h2>Product</h2>
