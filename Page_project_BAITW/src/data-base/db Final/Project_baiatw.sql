CREATE DATABASE  IF NOT EXISTS `project_baitw` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `project_baitw`;
...
INSERT INTO `admin` VALUES (1,'admin','$2y$10$hmcDEZaae0MxkcdEvWCiw.AxkwNV.ya2zKSSnKaBZQFTzzELJxRUu','Administrador','projectbaitw.05@gmail.com',NULL,0,1,'2023-10-17 20:06:31');
...
INSERT INTO `configuracion` VALUES (1,'tienda_nombre','Bicycle Association Industry Around the World'),(2,'correo_email',''),(3,'correo_smtp',''),(4,'correo_password','u2SanuWJqFPIWffOruM/+A==:ZAfyri6yAy3wd4cpMBC0rQ=='),(5,'correo_puerto','');
...
-- Dump completed on 2023-11-11 12:07:41
